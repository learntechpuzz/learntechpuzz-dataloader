...
public class ApplicationDataLoaderHandlerTest {
    ...
    @Test
    public void testAddCoursesHandler() {
        ApplicationDataLoaderHandler handler = new ApplicationDataLoaderHandler(s3Client);
